...
from app.forms import ResetPasswordForm, ResetPasswordRequestForm, PostForm, LoginForm, RegistrationForm, EditProfileForm, EmptyForm
...
def reset_password(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Zresetowaliśmy twoje hasło')
        return redirect(url_for('login'))
    return render_template('reset_password.htmk', form=form)